...
export const commonCssClasses = {
  ...
  getTabButton:
    'px-4 py-1.5 text-sm font-medium text-white bg-blue-500 border border-blue-600 rounded shadow hover:bg-blue-600 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed'
};

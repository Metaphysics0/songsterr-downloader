const sharedBtnStyle =
  'w-fit px-2 py-1 font-semibold p-2 rounded-lg shadow-md transition duration-75 cursor-pointer';
...
export const cssClasses = {
  ...
  downloadBtn: sharedBtnStyle + ' bg-red-500 hover:bg-red-400 text-white',
  downloadAllBtn:
    sharedBtnStyle + ' bg-yellow-500 hover:bg-yellow-400 text-white'
};
